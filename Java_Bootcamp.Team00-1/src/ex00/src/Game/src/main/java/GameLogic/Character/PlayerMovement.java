...
public class PlayerMovement {
    ...
    public void moveForward(int[][] map) throws IOException {
    ...
    public void moveBack(int[][] map) throws IOException {
        int x = data.getPlayerCoordinates()[0];
        int y = data.getPlayerCoordinates()[1];
    ...
    public void moveLeft(int[][] map) throws IOException {
        int x = data.getPlayerCoordinates()[0];
        int y = data.getPlayerCoordinates()[1];
        if (y == 0) {
    ...
    public void moveRight(int[][] map) throws IOException {
        int x = data.getPlayerCoordinates()[0];
        int y = data.getPlayerCoordinates()[1];
