...
public class GameManager {
    ...
    private void mapRendering() throws IOException  {
    ...
    public void checkGameStatus(int[][] map, int x, int y) throws IOException {
    ...
    private void updateMap(int[][] map, int x, int y, Objects object) throws IOException {
    ...
    private void checkPlayerAround(int[][] map, int x, int y) throws IOException {
