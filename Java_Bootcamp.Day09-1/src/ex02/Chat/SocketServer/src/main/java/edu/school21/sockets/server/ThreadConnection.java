...
public class ThreadConnection extends Thread {
    ...
    private void getClientAction() throws IOException {
        String clientWord = JSONConverter.parseToObject(bufferedReader.readLine()).getMessageText();
        if (clientWord != null) {
    ...
    private void startMessaging() {
        try {
            ...
            String message;
            while (!(message = JSONConverter.parseToObject(
    ...
    private void signUp() {
        try {
            ...
            username = JSONConverter.parseToObject(bufferedReader.readLine()).getMessageText();
            sendMessageClient("Enter password:");
            String password = JSONConverter.parseToObject(bufferedReader.readLine()).getMessageText();
    ...
    private void createRoom() {
        try {
            ...
            String roomName = JSONConverter.parseToObject(bufferedReader.readLine()).getMessageText();
    ...
    private int chooseRoom() {
        try {
            try {
                int clientWord = Integer.parseInt(JSONConverter.parseToObject(bufferedReader.readLine()).getMessageText());
                return clientWord;
