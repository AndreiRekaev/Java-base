...
public class ProductsRepositoryJdbcImplTest {
    private static final List<Product> EXPECTED_FIND_ALL_PRODUCTS = Arrays.asList(
            ...
            new Product(4L, "Bread", 60L),
            new Product(5L, "Potato", 80L)
    );
    ...
    private static final Product EXPECTED_SAVE_PRODUCT = new Product(6L, "Water", 55L);
    ...
    public void saveTest() {
        productsRepositoryJdbc.save(new Product(6L, "Water", 55L));
